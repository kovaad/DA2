...
msummary(list("Unconditional" = reg1,"Model1" = reg2, "Model2" = reg3,"Model3" =  reg4),
         ...
         stars=c('*' = .05, '**' = .01),
         coef_rename = c("female" = "Female", "grade920" = "No high school","grade9239" = "High school graduate","grade9240" = "College no degree","grade9241" = "Associate degree vocational","grade9242" = "Associate degree academic","grade9243" = "Bachelor's degree","grade9244" = "Master's degree","grade9245" = "Professional school","age" = "Age","agesq" = "Agesq")) %>% 
