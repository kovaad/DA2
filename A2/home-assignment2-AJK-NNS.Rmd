...
#logit model
logit <- glm(highly_rated ~ distance + stars + accommodation_type, data=london, family = "binomial")
#logit model marginal effects
logitm <- logitmfx(highly_rated ~ distance + stars + accommodation_type, data=london, atmean = F, robust = T)
#probit model
probit <- glm(highly_rated ~ distance + stars + accommodation_type, data=london, family = binomial(link = "probit"))
